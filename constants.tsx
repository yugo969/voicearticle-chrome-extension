/**
 * VoiceArticle Chrome Extension - Constants & Icons
 * アプリケーション全体で使用される定数とSVGアイコンコンポーネント
 */
...
export const SparklesIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.006 5.404.434c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354l-4.596 2.882c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.434L10.788 3.21z"
      clipRule="evenodd"
    />
  </svg>
);
...
export const SunIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      d="M12 3v2.25m6.364.386-1.591 1.591M21 12h-2.25m-.386 6.364-1.591-1.591M12 18.75V21m-6.364-.386 1.591-1.591M3 12h2.25m.386-6.364 1.591 1.591M12 12a2.25 2.25 0 0 0-2.25 2.25c0 1.242.666 2.046 1.076 2.046s1.076-.804 1.076-2.046A2.25 2.25 0 0 0 12 12z"
    />
  </svg>
);
...
export const MoonIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M21.752 15.002A9.72 9.72 0 0 1 18 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 0 0 3 11.25C3 16.635 7.365 21 12.75 21c3.978 0 7.443-2.343 9.002-5.998Z"
    />
  </svg>
);
